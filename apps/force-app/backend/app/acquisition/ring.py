...
class Ring:
    ...
    def put(self, t: np.ndarray, data: np.ndarray, timeout: Optional[float] = None) -> bool:
    ...
    def get(self, timeout: Optional[float] = None) -> Optional[tuple[np.ndarray, np.ndarray]]:
